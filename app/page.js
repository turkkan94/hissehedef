...
// import Widgets1 from "../components/common/Widgets1";
...
async function Home() {
  ...
  console.log(stocks.quoteResponse.result.length);
  return (
    <>
      <div className="page-content">
        <div className="container-fluid">
          <BreadCrumb title="Hisse Hedef" pageTitle="Hisse" />
          <div className="row">
          ...
          <div className="row">{/* <Widgets1 /> */}</div>
          <div className="row">
